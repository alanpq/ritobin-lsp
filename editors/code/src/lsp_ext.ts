...
export const cancelFlycheck = new lc.NotificationType0("ritobin-lsp/cancelFlycheck");
export const clearFlycheck = new lc.NotificationType0("ritobin-lsp/clearFlycheck");
export const expandMacro = new lc.RequestType<ExpandMacroParams, ExpandedMacro | null, void>(
    "ritobin-lsp/expandMacro",
);
export const memoryUsage = new lc.RequestType0<string, void>("ritobin-lsp/memoryUsage");
export const openServerLogs = new lc.NotificationType0("ritobin-lsp/openServerLogs");
export const relatedTests = new lc.RequestType<lc.TextDocumentPositionParams, TestInfo[], void>(
    "ritobin-lsp/relatedTests",
);
export const reloadWorkspace = new lc.RequestType0<null, void>("ritobin-lsp/reloadWorkspace");
export const rebuildProcMacros = new lc.RequestType0<null, void>("ritobin-lsp/rebuildProcMacros");
